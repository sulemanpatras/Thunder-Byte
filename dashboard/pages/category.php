      ...
      <main>
         ...
         <div class="insights">
            ...
            <div class="expenses">
              ...
              include "../auth/conn.php";
              // SQL query to get the total count of table rows where gender is 'Male'
              $sql = "SELECT COUNT(*) as total FROM services  WHERE category = 'Standard'";
              $result = $conn->query($sql);
            ...
            <div class="income">
              ...
              include "../auth/conn.php";
              // SQL query to get the total count of table rows where gender is 'Male'
              $sql = "SELECT COUNT(*) as total FROM services  WHERE category = 'Premier'";
              $result = $conn->query($sql);
            ...
            <table>
               ...
               if ($result) {
                  while ($row = mysqli_fetch_assoc($result)) {
                     ...
                     echo '<td><a class="success" href="up-del/category-update.php?az=' . $row['id'] . '">Update</a></td>';
                     echo '<td><a class="warning" href="up-del/category-delete.php?delete=' . $row['id'] . '">Delete</a></td>';
                     echo '</tr>';
                  }
