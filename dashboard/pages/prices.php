            ...
            <table>
               ...
               if ($result) {
                  while ($row = mysqli_fetch_assoc($result)) {
                     ...
                     echo '<td><a class="success" href="up-del/price-update.php?az=' . $row['id'] . '">Update</a></td>';
                     echo '<td><a class="warning" href="up-del/price-delete.php?delete=' . $row['id'] . '">Delete</a></td>';
                     echo '</tr>';
                  }
