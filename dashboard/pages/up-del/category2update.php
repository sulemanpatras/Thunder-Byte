                    ...
                    <table>
                        <tbody>
                                ...
                                <div class="formbold-form-wrapper">
                                    <form action="#" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="formbold-input-flex">
                                            <!-- Service Name -->
                                            <div>
                                                <label for="firstname" class="formbold-form-label"> Category 
                                                </label>
                                                <input type="text" name="category" id="firstname" value="<?php echo $name; ?>" placeholder="Service" class="formbold-form-input" required />
                                            </div>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = $sql = "UPDATE category2 SET category_name='$category' WHERE id=$id";
