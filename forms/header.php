  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar" style="margin-right:80px;">
        ...
        <?php if ($login): ?>
          <a href="./forms/logout.php" class="btn-get-started scrollto" id="fiverr" style=" margin-right: -180px;
  margin-top:0px;">Logout</a>
<?php else: ?><a href="./forms/login.php" class="btn-get-started scrollto" id="fiverr" style=" margin-right: -180px;
  margin-top:0px;">Signup/Login</a> <?php endif; ?>
